    ...
    <section id="skills">
      <div className="container px-5 py-10 mx-auto border-t-[3px]">
        ...
        <CpuChipIcon className="w-10 inline-block mb-4 text-white" />
          ...
          Due to rapid changes in technology, I actively stay abreast with emerging trends in the tech industry. My work experience, coupled with the classes i've taken, has exposed me to the following technologies.
          </p>
        </div>
