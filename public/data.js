...
export const projects = [
    ...
    // {
    //   title: "studyti.me",
    //   status:"In Progress - Database no longer supported",
    //   subtitle: "React Application",
    //   description:
    //     "Study tool meant to keep track of todos and displays a Pomodoro Timer in order to keep track of work done",
    //   image: "https://c4.wallpaperflare.com/wallpaper/600/919/630/digital-art-illustration-lofi-hd-wallpaper-preview.jpg",
    //   link: "https://studytimev1.vercel.app/",
    //   github: "https://github.com/yassarrich/studytime-version1",
    //   tech: ["React", "Vercel", "Firebase"]
    // },
    // {
    //   title: "Python Tech News App",
    //   status:"In Progress - currently migrating resources",
    //   subtitle: "HTML CSS and Python",
    //   description:
    //     "Full Stack web app hosted on a Ubuntu Server using Nginx. This project is my introduction to the software development life cycle, Currently working on adding React frontend to display news article more aesthetically, under maintencance",
